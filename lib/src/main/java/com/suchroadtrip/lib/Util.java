...
public class Util {
    ...
    private static final String FORMAT_MAP_URL = "http://maps.googleapis.com/maps/api/staticmap?center=%f,%f&markers=%f,%f&zoom=15&size=400x400&key=AIzaSyCAJbA5io-Jb97Y-vwSNJI6y64DcCyAZoE&sensor=false";
